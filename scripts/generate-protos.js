...
function generateIndex() {
  ...
  const services = fs
    .readdirSync(PROTO_OUT_DIR, { withFileTypes: true })
  ...
  fs.writeFileSync(path.join(PROTO_OUT_DIR, 'index.ts'), indexContent + '\n');
}
